...
void InitTracer()
{
    // Create OTLP exporter instance using http
...
{
    // todo: add parameter to select otlp-http or otlp-grpc
    if (argc > 1) {
        // export to otel-collector or jaeger-collector both of which have same
